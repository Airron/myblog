...
<div id="mainbody">
  <div class="blogs">
    <div id="index_view">
      <h2 class="t_nav"><a href="${pageContext.request.contextPath}/index.action">网站首页</a>
      <a href="${pageContext.request.contextPath}/navigateBynavid.action?navid=<%=request.getSession().getAttribute("navid")%>">慢生活</a></h2>
