...
<a href="/jstt/div/2013-08-10/576.html" target="_blank" title=" li列表在网页中常见应用例举（二）"><img src="images/s1.jpg" class="imgdow" alt=" li列表在网页中常见应用例举（二）"></a> <p class="pcon">li列表加时间，li列表背景图片的应用，li标签里面的span应该放在前面，如果放在后面IE浏览器较低版本会出现错位 <a href="/jstt/div/2013-08-10/576.html" target="_blank" title=" li列表在网页中常见应用例举（二）">详细信息</a></P>
<div class="line"></div>
